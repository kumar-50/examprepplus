...
CREATE TYPE "public"."exam_type" AS ENUM('RRB_NTPC', 'SSC_CGL', 'BANK_PO', 'OTHER');
CREATE TYPE "public"."difficulty_level" AS ENUM('easy', 'medium', 'hard');
CREATE TYPE "public"."test_type" AS ENUM('mock', 'live', 'sectional', 'practice');
...
ALTER TABLE "topics" ADD CONSTRAINT "topics_section_id_sections_id_fk" FOREIGN KEY ("section_id") REFERENCES "public"."sections"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "test_questions" ADD CONSTRAINT "test_questions_section_id_sections_id_fk" FOREIGN KEY ("section_id") REFERENCES "public"."sections"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "user_test_attempts" ADD CONSTRAINT "user_test_attempts_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "user_test_attempts" ADD CONSTRAINT "user_test_attempts_test_id_tests_id_fk" FOREIGN KEY ("test_id") REFERENCES "public"."tests"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "user_answers" ADD CONSTRAINT "user_answers_attempt_id_user_test_attempts_id_fk" FOREIGN KEY ("attempt_id") REFERENCES "public"."user_test_attempts"("id") ON DELETE cascade ON UPDATE no action;
